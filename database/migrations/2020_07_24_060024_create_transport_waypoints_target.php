...
class CreateTransportWaypointsTarget extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transport_waypoints_target', function (Blueprint $table) {
            $table->id()->index('id');
    ...
    {
        Schema::dropIfExists('transport_waypoints_target');
    }
}
