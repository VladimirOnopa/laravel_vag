...
class CreateCargoWaypointsSource extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cargo_waypoints_source', function (Blueprint $table) {
            $table->id()->index('id');
    ...
    {
        Schema::dropIfExists('cargo_waypoints_source');
    }
}
