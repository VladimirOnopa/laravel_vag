...
@if(isset($data['empty']))
    ...
    <div class="container cargo no_request">
        ...
        <img src={{asset('image/archive-icon.png')}} alt="empty">
    </div>
                ...
                <div class="col-md-2 actions_links">
                    <div class="dropdown show">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="#">Редактировать заявку</a>
                        <a class="dropdown-item" href="/refresh_request/{{$cargo->id}}">Активировать заявку</a>
